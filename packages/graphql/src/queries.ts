...
export const listApplications = /* GraphQL */ `
    query ListApplications($filter: ModelApplicationFilterInput, $limit: Int, $nextToken: String) {
...
export const listSearchAlerts = /* GraphQL */ `
    query ListSearchAlerts($filter: ModelSearchAlertFilterInput, $limit: Int, $nextToken: String) {
...
export const searchStudents = /* GraphQL */ `
    query SearchStudents(
        ...
        searchStudents(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken) {
            items {
                id
                email
                phoneNumber
...
export const searchApplications = /* GraphQL */ `
    query SearchApplications(
        ...
        searchApplications(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken) {
            items {
                id
                studentId
                student {
...
export const searchSchools = /* GraphQL */ `
    query SearchSchools(
        ...
        searchSchools(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken) {
            items {
                city
                country
                coverPhoto
...
export const searchPrograms = /* GraphQL */ `
    query SearchPrograms(
        ...
        searchPrograms(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken) {
            items {
                applicationFee
                applicationFeeCurrency
                city
