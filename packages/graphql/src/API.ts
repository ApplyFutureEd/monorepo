...
export type OnUpdateApplicationByIdSubscriptionVariables = {
    id?: string;
};

export type OnUpdateApplicationByIdSubscription = {
...
export type OnUpdateStudentByIdSubscriptionVariables = {
    id?: string;
};

export type OnUpdateStudentByIdSubscription = {
    onUpdateStudentById?: {
        __typename: 'Student';
        id: string;
        address?: string | null;
