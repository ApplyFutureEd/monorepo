module.exports = {
    ...
    pages: {
        ...
        '/careers': ['landing'],
        '/help': ['help'],
        '/onboarding/country': ['profile'],
        '/onboarding/degree': ['profile', 'programs'],
        '/onboarding/discipline': ['profile'],
        '/onboarding/highest-education-level': ['profile', 'programs'],
        '/onboarding/suggestions': ['profile', 'programs'],
