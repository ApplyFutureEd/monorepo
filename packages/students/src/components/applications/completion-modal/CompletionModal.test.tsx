...
describe('CompletionModal', () => {
    ...
    it('can render without crashing', () => {
        render(<CompletionModal application={application} />);

        const title = screen.getByText('application:completed-modal-title');
    ...
    it('can prevent opening if application is missing', () => {
        ...
        const title = screen.queryByText('application:completed-modal-title');
    ...
    it('can call onClose callback function when the close icon is clicked', async () => {
        ...
        const closeIcon = screen.getAllByRole('img', { hidden: true })[0];
    ...
    it('can call onRate callback function after rating', async () => {
        render(<CompletionModal application={application} />);

        const starIcon = screen.getAllByRole('img', { hidden: true })[2];
