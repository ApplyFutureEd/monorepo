...
describe.skip('ReviewDocumentsProgress', () => {
    const application = ({
    ...
    it('can render without crashing', () => {
        render(<ReviewDocumentsProgress application={application} />);

        const cancelButton = screen.getByText('application:cancel-my-application');
        const continueButton = screen.getByText('application:continue-my-application');

        expect(cancelButton).toBeInTheDocument;
        expect(continueButton).toBeInTheDocument;
    });

    it('can handle the cancel workflow', async () => {
        render(<ReviewDocumentsProgress application={application} />);
    ...
    it('can display a toast if an error is catch in the cancel workflow', async () => {
        render(<ReviewDocumentsProgress application={corruptedApplication} />);
