...
describe.skip('SchoolResultProgress', () => {
    ...
    it('can render without crashing', () => {
        ...
        const description = screen.getByText('application:admission-result-waiting-list');
    ...
    it('can render nothing if admission result is not set', () => {
        ...
        const { container } = render(<SchoolResultProgress application={pendingApplication} />);
