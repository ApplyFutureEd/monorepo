...
describe('SchoolResultDone', () => {
    ...
    it('can render without crashing', () => {
        render(<SchoolResultDone application={application} />);

        const description = screen.getByText('application:admission-result-accepted');
    ...
    it('can render nothing if admission result is not set', () => {
        ...
        const { container } = render(<SchoolResultDone application={pendingApplication} />);
