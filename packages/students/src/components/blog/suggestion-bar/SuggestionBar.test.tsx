...
describe('Posts', () => {
    it('can render without crashing', () => {
        ...
        render(<SuggestionBar posts={suggestedPosts} />);

        const author = screen.getByText('Clémence Pirault');
        const title = screen.getByText('My reconversion in web development');
