...
import C from '../../src/pages_/schools'
...
const ns5 = await import(`../../locales/${_lang}/programs`).then(m => m.default)
const ns6 = await import(`../../locales/${_lang}/schools`).then(m => m.default)
  const _ns = { 'auth': ns0, 'common': ns1, 'navigation': ns2, 'application': ns3, 'landing': ns4, 'programs': ns5, 'schools': ns6 }
