...
import C from '../../src/pages_/recruiters'
...
const ns3 = await import(`../../locales/${_lang}/landing`).then(m => m.default)
const ns4 = await import(`../../locales/${_lang}/recruiter-form`).then(m => m.default)
  const _ns = { 'auth': ns0, 'common': ns1, 'navigation': ns2, 'landing': ns3, 'recruiter-form': ns4 }
