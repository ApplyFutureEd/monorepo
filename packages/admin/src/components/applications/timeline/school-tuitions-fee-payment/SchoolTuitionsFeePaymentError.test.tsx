...
describe.skip('SchoolTuitionsFeePaymentError', () => {
    const application = ({
    ...
    it('can render without crashing', () => {
        render(<SchoolTuitionsFeePaymentError application={application} />);
    ...
    it('can display a toast if an error is catch in the undo workflow', async () => {
        render(<SchoolTuitionsFeePaymentError application={corruptedApplication} />);
