...
describe.skip('InternalReviewError', () => {
    const application = ({
    ...
    it('can render without crashing', () => {
        render(<InternalReviewError application={application} />);

        const description = screen.getByText('Wait for student to upload missing documents');
    ...
    it('can display a toast if an error is catch in the undo workflow', async () => {
        render(<InternalReviewError application={corruptedApplication} />);
