...
describe.skip('InternalReviewProgress', () => {
    const application = ({
    ...
    it('can render without crashing', () => {
        render(<InternalReviewProgress application={application} />);
    ...
    it('can display a toast if an error is catch in the reject workflow', async () => {
        render(<InternalReviewProgress application={corruptedApplication} />);
