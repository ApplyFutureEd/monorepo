...
import { SearchApplicationsQuery, SearchProgramsQuery } from '@applyfuture/graphql';
...
describe('Table', () => {
    ...
    it('can render without crashing', () => {
        ...
        const applicationDate = screen.getByText('10/05/21 16:05');
    ...
    it('can search data', (done) => {
        ...
        userEvent.type(searchInput, '20E67E');
    ...
    it('can filter data', (done) => {
        ...
        userEvent.type(nameFilterInput, '20E67E');
